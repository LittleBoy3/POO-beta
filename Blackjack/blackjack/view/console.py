...
class UIConsola:
    ...
    def __init__(self):
        ...
        self.opciones = {
            ...
            "2": self.continuar_juego,
            "3": self.revelar_carta_oculta_casa,
            "4": self.salir
        }
    ...
    def mostrar_menu(self):
        ...
        print("3. Revelar carta oculta de la casa")
        print("4. Salir")
        print(f"{'_':_^30}")
    ...
    def ejecutar_app(self):
        ...
        while True:
            ...
            if opcion == "1":
                ...
                self.revelar_carta_oculta_casa()  
            elif opcion == "4":
                self.salir()
            else:
    ...
    def iniciar_nuevo_juego(self):
        ...
        if not self.blackjack.jugador.mano.es_blackjack():
            ...
            self.mostrar_resultado_y_regresar_menu()  

    def continuar_juego(self):
        if not self.juego_en_curso:
            print("No hay un juego en curso para continuar.")
            return
    ...
    def ejecutar_turno_de_la_casa(self):
        if self.blackjack.jugador.mano.calcular_valor() == 21:
            ...
            if self.blackjack.casa_gano():
                ...
                self.determinar_resultado_del_juego()

    def determinar_resultado_del_juego(self):
        if self.blackjack.jugador_gano():
            print("¡Felicidades, ganaste el juego!")
        elif self.blackjack.casa_gano():
            print("La casa ganó el juego.")
        else:
    ...
    def mostrar_resultado_y_regresar_menu(self):
        if self.blackjack.jugador_gano():
            print("¡Felicidades, ganaste el juego!")
        elif self.blackjack.casa_gano():
            print("La casa ganó el juego.")
